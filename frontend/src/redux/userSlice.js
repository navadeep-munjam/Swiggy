...
const userSlice=createSlice({
    ...
    initialState:{
        ...
        myOrders:[],
        ownerPendingOrders:[],
  // socket removed from Redux state
        deliveryBoys:[],
        searchItems:null,
  ...
  // setSocket removed; socket should not be in Redux
...
export const {setUserData,setCity,setAllShops,setShop,setShopsOfCity,setItemsOfCity,addToCart,updateQuantity,removeFromCart,setMyOrders,setOwnerPendingOrders,setDeliveryBoys,setSearchItems,setPendingOrdersCount}=userSlice.actions
